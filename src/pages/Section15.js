...
const Section15 = () => {
  return (
    <section className="bg-white bg-center bg-cover xl:bg-fixed">
        ...
        <div className="flex flex-row">
          <div className="flex flex-col">
            <div className="basis-2/3 md:basis-1/2">
              <TitleHeadline textcolor1="text-black" textcolor2="text-black" c_headline1="멋지게 해내는 것" c_headline2="최고의 팀에 합류하세요" />
              <button className="font-medium text-left bg-white md:text-md2 py-14 xl:py-16 xl:text-base text-primary backdrop-blur-md rounded-8 xl:rounded-full hover:text-black">

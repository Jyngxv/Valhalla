    ...
    <section className="relative z-10 overflow-y-hidden bg-black xl:py-0">
      <div className="container relative my-auto md:py-96 md:px-48 lg:py-128 lg:px-64 xl:py-256 xl:px-0">
        <div className="flex flex-col mt-[380px] md:mt-0">
          ...
          <p className="text-2xl font-bold text-center text-white md:text-left md:text-6xl xl:text-8xl font-Bebas mt-[-20px] md:mt-8">{count} PETSONALS</p>
          <p className="mb-24 text-2xl font-bold  text-center text-white md:text-left md:text-6xl xl:text-8xl md:mb-96 xl:mb-128 font-Bebas mt-[-8px] xl:mt-[-20px] md:mt-0">
            Already with us
          </p>
      ...
      {/* <div className="absolute top-[50%] left-[50%] w-screen h-screen z-[-1]">
        <video autoPlay className="absolute top-0 left-0 mx-auto translate-x-[-50%] translate-y-[-50%] z-30" loop muted>
          <source src="video/p_video_petsonal.mp4"></source>
        </video>
      </div> */}
    </section>

...
const menuList = {
  0: <Commerce c_text1="오늘이 지나면" c_text2="신데랄라처럼 사라져요" c_text3="365일 24시간 타임세일" c_img="img/p_device_commerce_today.png"></Commerce>,
  1: (
    <Commerce c_text1="차원이 다른" c_text2="빠른 직배송 서비스" c_text3="직배송 상품으로 한번에, 빠르게" c_img="img/p_device_commerce_delivery.png"></Commerce>
  ),
  2: (
    <Commerce
      c_text1="인기가 많다는 것은"
  ...
  3: <Commerce c_text1="천하제일" c_text2="멍냥이 자랑대회" c_text3="참가만해도 포인트 지급" c_img="img/p_device_commerce_awards.png"></Commerce>,
};
    ...
    return (
      <div className="flex flex-col w-100% md:w-100% tab02 overflow-x-auto">
        ...
        <div className="mx-auto px-24 md:px-48 md:w-100% xl:w-1280">
          <div className="mx-auto overflow-hidden xl:ml-auto contentArea ">{menuList[this.state.menu]}</div>
        </div>
      </div>
    );
  }
